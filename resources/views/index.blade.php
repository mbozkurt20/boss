                    ...
                    <div class="swiper-wrapper">
                        <div id="slide_one" class="swiper-slide">
                            ...
                            <video class="slider-video" width="100%" preload="auto" loop="" autoplay="" style="visibility: visible; width: 100%;" poster="">
                                <source src="{{asset('assets/new images/videoplayback.mp4')}}" type="video/mp4">
                            </video>
                            <!-- END VIDEO -->
                        </div>
                        ...
                        <a href="/product/{{$product->slug}}">
                            <div class="product-item {{$product->category_id}} ">
                                <div class="product discount product_filter">
                                    ...
                                    @else
                                        <img class="h-25"  src="{{asset('assets/new images/WebsiteBOSS.png')}}" alt="">
                                    @endif
                                    <div class="product_info mt-3">
                                        ...
                                        @if(! Auth::guest())
                                            <div class="col-md-4 col-sm-12 text-center " style="font-size: 12px">{{ number_format($product->product_price,2,',','.').'$'  }} </div>
                                        @else
                                            <span>Gizli</span>
                                        @endif
                                        <br>
