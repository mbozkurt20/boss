        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-header"><?php echo e(__('ÜYELİK BİLGİLERİ')); ?></div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('register')); ?>" aria-label="<?php echo e(__('Register')); ?>">
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label text-md-right"><?php echo e(__('İsim*')); ?></label>
                            ...
                            <div class="form-group row">
                                <label for="surname" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Soyisim*')); ?></label>
                            ...
                            <div class="form-group row">
                                <label for="kimlik" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Tc Kimlik Nu*')); ?></label>

                                <div class="col-md-6">
                                    <input id="kimlik" type="text"
                            ...
                            <div class="form-group row">
                                <label for="telefon" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Cep Numaranız*')); ?></label>
                            ...
                            <div class="form-group row">
                                <label for="email"
                                       class="col-md-4 col-form-label text-md-right"><?php echo e(__('E-Mail Adresi*')); ?></label>
                            ...
                            <div class="form-group row">
                                <label for="password"
                                       class="col-md-4 col-form-label text-md-right"><?php echo e(__('Şifreniz*')); ?></label>
                            ...
                            <div class="form-group row">
                                <label for="password-confirm"
                                       class="col-md-4 col-form-label text-md-right"><?php echo e(__('Şifrenizi Doğrulayın*')); ?></label>
