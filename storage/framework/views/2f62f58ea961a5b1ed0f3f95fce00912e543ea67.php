...
<body>
<img class="img-fluid" src="<?php echo e(public_path('assets/new images/logoo.jpeg')); ?>"  height="50">
<br>
<br>
<br>
<br>
<table style="width: 100%">
    ...
    <?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr style="border: none">
            ...
            <td></td>
            <td  style=" border-right: solid 1px black;font-family: DejaVu Sans, sans-seri"><?php echo e(\App\Product::find($data->id)->product_detail); ?></td>
            <td></td>
            <td><?php echo e($data->qty. 'x' .  number_format(\App\Product::find($data->id)->product_price,2,',','.') . '$'); ?></td>
            <td></td>
        </tr>

    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </tbody>
    <p style="margin-left: 80%;font-family: DejaVu Sans, sans-seri">Amount : <strong> <?php echo e(number_format($amount ,2 , '.',',')); ?> $</strong></p>
</table>
<br>
<br>
<br>
