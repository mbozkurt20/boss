                            ...
                            <div class="product-item <?php echo e($product->category_id); ?> ">
                                <div class="product discount product_filter">
                                    ...
                                    <div class="product_info mt-3">
                                        ...
                                        <div class="col-md-4 col-sm-12 product_price" style="font-size: 12px"><?php echo e(number_format($product->dolar)); ?> <small>$</small></div>
                                        <div class="col-md-4 col-sm-12 product_price" style="font-size:12px"><?php echo e(number_format($product->kisiself)); ?><small>₺</small></div>
                                        <div class="col-md-4 col-sm-12 product_price " style="font-size: 12px"><?php echo e(number_format($product->euro)); ?> <small>€</small> </div>
