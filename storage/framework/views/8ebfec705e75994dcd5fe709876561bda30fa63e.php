<?php $__env->startSection("content"); ?>
    <aside class="side-nav" id="show-side-navigation1">
        ...
        <div class="heading">
            <img src="<?php echo e(asset('assets/new images/logo2.png')); ?>" alt="">
            <div class="info">
                <h3 class="mx-2"><a class="mx-2" href="#"><?php echo e(config('app.name')); ?></a></h3>
            </div>
        </div>
        <div class="search">
...
Buraya yaz"><i class="fa fa-search"></i>
        ...
        <ul class="categories">
            ...
            <li><i class="fa fa-envelope-open-o fa-fw"></i><a href="<?php echo e(route('silinenMesajlar')); ?>">Silinen ve Cevaplanan Mesajlar <span class="num prim"><?php echo e($silinenCount); ?></span></a>
            </li>
        </ul>
    </aside>
    <section id="contents">
        ...
        <div class="welcome">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="content">
                            <h3 class="text-white"><?php echo e(config('app.name')); ?> Kontrol Paneli</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="box bg-primary">
                            ...
                            <br>
                            <p class="text-white lead"><?php echo e($order); ?></p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="box danger">
                            ...
                            <br>
                            <p class="text-white lead"><?php echo e($user); ?></p>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="box warning">
                            ...
                            <br>
                            <p class="text-white lead"><?php if(isset($product)): ?><?php echo e($product); ?><?php endif; ?> </p>
                        </div>
                    </div>
                    <div class="col-md-3">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('import')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <a class="btn btn-warning" href="<?php echo e(route('export')); ?>">Export Product Data</a>
            </form>
        </div>
    </section>
