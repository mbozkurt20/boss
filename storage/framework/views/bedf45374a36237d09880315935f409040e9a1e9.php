    ...
    <div class="super_container">
        ...
        <header class="header trans_300">
            <!-- Top Navigation -->
            <div class="top_nav" style="background-color: ghostwhite;color: black" >
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <marquee scrollamount="2" behavior="" direction="down"><p class="text-dark">DenizDuru Güvenli Alışverişin Yeni Adresi...</p> </marquee>
                        </div>
                                ...
                                <ul class="top_nav_menu">
                                    ...
                                    <?php if(Auth::guest()): ?>
                                        <div class="dropdown show">
                                            <a class="btn btn-outline-dark dropdown-toggle mt-2" style="font-size: small" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                Giriş Yap
                                            </a>
                                    ...
                                    <?php else: ?>
                                        <li class="account" style="background-color: transparent;color: black">
                                            <a href="#">
                                            ...
                                            <ul class="account_selection">
                                                ...
                                                <?php if(Auth::user()): ?>
                                                    ...
                                                    <li><a href="<?php echo e(url('/orders')); ?>"><i class="fa fa-btn fa-list-alt"></i>Siparişlerim</a>
                                                    </li>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-right">
                                <div class="logo_container text-center">
                                    ...
                                    <p class="text-uppercase font-weight-bold" style="color: purple;letter-spacing: 3px "> <img style="height: 45px;width: 45px" src="<?php echo e(asset("assets/new images/newnew.png")); ?>"> <?php echo e(config('app.name')); ?>  <small>Bilgi Teknolojileri</small></p>

                                </div>
                            <nav class="navbar">
                                <ul class="navbar_menu">
                                    <li><a href="/">Anasayfa</a></li>
                                    <li><a href="<?php echo e(route('hakkimizda')); ?>">Hakkımızda</a></li>
                                    <div class="dropdown"style="z-index: 100">
                                        <button class="dropbtn " style="font-size:14px"><?php echo e(config('app.name')); ?> KATEGORİ</button>
                                        <div class="dropdown-content">
                                            <?php $__currentLoopData = $categoryMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <a class="text-dark" href="/category/<?php echo e($menu->slug); ?>"><?php echo e($menu->category_name); ?></a>
                                    ...
                                    <ul class="visible-for-medium-down hidden-sm hidden-xs">
                                        <form class="navbar-form" action="<?php echo e(route('search.product')); ?>" method="post">
                                            ...
                                            <div class="form-group-sm">
                                                <input type="text" class="form-control input-group-sm submit_on_enter" name="search" placeholder="Ürün İsmi">
                                            </div>
        ...
        <div class="hamburger_menu">
            ...
            <div class="hamburger_menu_content text-right">
                <ul class="menu_top_nav">
                    ...
                    <li class="menu_item"><a href="<?php echo e(route('hakkimizda')); ?>">HAKKIMIZDA</a></li>
                    <?php $__currentLoopData = $categoryMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <li class="menu_item has-children">
                            ...
                            <ul class="menu_selection">
                                ...
                                <?php if(Auth::user()): ?>
                                    ...
                                    <li><a href="<?php echo e(url('/orders')); ?>"><i class="fa fa-btn fa-list-alt"></i>Siparişlerim</a></li>
                                        <li><a href="<?php echo e(route('change.password')); ?>"><i class="fa fa-btn fa-key"></i>Şifre Yenileme</a></li>
                                <?php endif; ?>
                                <li><a href="<?php echo e(url('/logout')); ?>"><i class="fa fa-btn fa-sign-out"></i>Çıkış Yap</a>
                                </li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mt-5">
                        ...
                        <a style="margin-left: 395px" title="Mesaj Gönder" href="<?php echo e(route('contact')); ?>"><img style="margin-bottom: -10px;height: 55px;width: 55px" src="https://iconarchive.com/download/i94049/scafer31000/bubble-circle-2/Message.ico" alt=""></a>
                    </div>
                </div>
            </div>
        </footer>
