                    ...
                    <div class="row">
                        <div class="col-lg-12 text-right">
                                <div class="logo_container text-center">
                                        ...
                                        <p class="text-uppercase font-weight-bold" style="color: black  ;letter-spacing: 3px "> <img style="" src="<?php echo e(asset("assets/new images/logo2.png")); ?>"> <?php echo e(config('app.name')); ?></p>
