...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.category', compact('categories', 'categoryMenu','mainyonetim'));
    }
    ...
    public function create()
    {
        ...
        return view("admin.category-create", compact('categories', 'categoryMenu','mainyonetim'));
    }
    ...
    public function edit($id)
    {
        ...
        $categories = Category::pluck('category_name', 'id')->all();
        return view("admin.category-edit", compact('category', 'categories', 'categoryMenu','mainyonetim'));
    }
